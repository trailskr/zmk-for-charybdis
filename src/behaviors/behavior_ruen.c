...
static const struct behavior_parameter_value_metadata param_values[] = {
    ...
    {.display_name = ".", .value = RUEN_DOT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = ",", .value = RUEN_COMMA, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = ";", .value = RUEN_SEMI, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = ":", .value = RUEN_COLON, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "\"", .value = RUEN_DQT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "?", .value = RUEN_QMARK, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "/", .value = RUEN_FSLH, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "[", .value = RUEN_LBKT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "]", .value = RUEN_RBKT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "{", .value = RUEN_LBRC, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "}", .value = RUEN_RBRC, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "<", .value = RUEN_LT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = ">", .value = RUEN_GT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "`", .value = RUEN_GRAVE, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "~", .value = RUEN_TILDE, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "@", .value = RUEN_AT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "#", .value = RUEN_HASH, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "$", .value = RUEN_DLLR, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "^", .value = RUEN_CARET, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "&", .value = RUEN_AMPS, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "|", .value = RUEN_PIPE, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "'", .value = RUEN_SQT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    {.display_name = "№", .value = RUEN_NUM, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
    ...
    {.display_name = "%", .value = RUEN_PRCNT, .type = BEHAVIOR_PARAMETER_VALUE_TYPE_VALUE},
